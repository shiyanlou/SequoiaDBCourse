...
```javascript
var coordNode=coordRG.createNode ( "sdbserver1", 11910, "/opt/sequoiadb/database/coord/11910/", { logfilenum : 5 , transactionon : true } ) ;
```
...
```javascript
var cataNode=cataRG.createNode ( "sdbserver1", 11900, "/opt/sequoiadb/database/cata/11900/", { logfilenum : 5 , transactionon : true } ) ;
```
