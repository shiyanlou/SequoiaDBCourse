...
```javascript
db.company.translog.insert( { serial_no : 1 , account_id : '1001' , description : "login" , tx_time : { '$date' : '2020-03-02' } } ) ;
```

从主集合插入 2021 年 1 月份的数据：

```javascript
db.company.translog.insert( { serial_no : 2 , account_id : '1001' , description : "login" , tx_time : { '$date' : '2021-01-01' } } ) ;
```
...
```sql
INSERT INTO  translog  VALUES (3, 000001, 'LOGIN ...', '2020-05-21') ;
```
