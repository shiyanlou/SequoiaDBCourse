...
>Note:
>
>挂载语句中的 `$date` 表示字段 tx_time 的数据类型为 date 类型。
...
```javascript
db.company.translog.insert( { "serial_no" : 2 , "account_id" : "20210101008" , "bus_pay_no" : "4321a297-15b4-4528-9034-cc21a256708" , "tx_time" : { "$date" : "2021-01-01" } } ) ;
```
