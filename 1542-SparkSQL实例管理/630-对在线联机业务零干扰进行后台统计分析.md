...
本课程中 SequoiaDB 巨杉数据库的集群拓扑结构为三分区三副本，其中包括 3 个引擎协调节点，1 个编目节点与 3 个数据组。 部署了 1 个 SequoiaSQL-MySQL 数据库实例节点，1 个 SequoiaSQL-SparkSQL 数据库实例，其中 SequoiaSQL-SparkSQL 实例包括 2 个 worker 节点。

![图片描述](https://doc.shiyanlou.com/courses/1542/1207281/b3e6bd2102872395094ba04c29924b0a-0)
...
2）在 Mysql Shell 中查看 MySQL 实例使用的协调节点；
...
![1542-9](https://doc.shiyanlou.com/courses/1542/1207281/d22c3292690e48a763c4beb298998fed-0)
