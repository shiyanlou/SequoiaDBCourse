...
详细了解快速部署工具：
* [SequoiaDB 快速部署工具](http://doc.sequoiadb.com/cn/SequoiaDB-cat_id-1557810775-edition_id-304)
...
本课程简单介绍了如何快速创建巨杉数据库集群和部署数据库实例。在安装过程中，可根据实际需要设置相应的安装路径，用户名，密码等配置信息。
